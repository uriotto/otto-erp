...
export function EditProfileDialog({ initialFullName, onClose }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 sm:items-center sm:p-4">
      <div className="bg-cream w-full max-w-md rounded-t-2xl p-6 shadow-xl sm:rounded-2xl">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-display-sm text-navy">עריכת פרופיל</h2>
          <button
            onClick={onClose}
        ...
        <form action={action} className="space-y-4">
          <div>
            <label className="text-micro text-ink-soft mb-1 block uppercase">שם מלא</label>
            <input
              name="full_name"
